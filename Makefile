...
OPTIONS = -O3 -DF_CPU=120000000 -DUSB_SERIAL -DLAYOUT_US_ENGLISH
...
TOOLSPATH = /home/gmtii/arduino-1.6.5-r5/hardware/tools
#old: TOOLSPATH = ../../../tools   # on Linux
#TOOLSPATH = ../../../tools/avr/bin   # on Mac or Windows

# path location for Arduino libraries (currently not used)
LIBRARYPATH = /home/gmtii/arduino-1.6.5-r5/hardware/teensy/avr/libraries/

# path location for the arm-none-eabi compiler
COMPILERPATH = /home/gmtii/arduino-1.6.5-r5/hardware/tools/arm/bin/
